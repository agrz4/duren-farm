        ...
        <div className="bg-white rounded-[3rem] p-10 shadow-sm min-h-screen border border-slate-50">
            ...
            <div className="grid grid-cols-12 gap-10">
                ...
                <div className="col-span-12 lg:col-span-4 space-y-6">
                    ...
                    <div className="bg-emerald-600 p-8 rounded-[3rem] text-white flex flex-col items-center text-center">
                        <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-4">
                            <MdOutlineModeEditOutline size={32} />
                        </div>
                        <h4 className="text-lg font-bold">Punya masukan?</h4>
                        <p className="text-xs opacity-70 mt-2 leading-relaxed">Ceritakan pengalaman Anda menikmati durian kami untuk membantu pembeli lain.</p>
                        <button className="w-full mt-6 bg-white text-emerald-600 py-4 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-colors shadow-lg">
                            Tulis Ulasan
                        </button>
                    </div>
                </div>
